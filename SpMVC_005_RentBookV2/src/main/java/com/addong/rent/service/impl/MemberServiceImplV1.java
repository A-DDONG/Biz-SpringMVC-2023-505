...
import com.addong.rent.dao.MemberDao;
...
public class MemberServiceImplV1 implements MemberService {
	...
	/*
	 * 회원을 등록할때 새로운 코드를 생성하여 memberDto 에 업데이트하고 회원정보 insert 하기
	 */
	@Override
	...
	public int update(MemberDto memberDto) throws Exception {
		...
		/*
		 * 수정하기 위해서 입력한 이름과 전화번호로 SELECT 를 했는데 데이터가 있다 1. 만약 m_code 가 같다 : 이름과 전화번호를
		 * 변경하지 않고 저장하기를 클릭했다 2. 만약 m_code 가 다르다 : 이미 등록된 회원의 이름 전화번호로 수정을 시도하였다 ->
		 * 중복데이터 오류
		 */
