...
document.addEventListener("DOMContentLoaded", () => {
  ...
  1. 변수1의 값이 fasle 가 아니면 변수 1의 값을 왼쪽에 대입
  2. 변수2의 값이 false 이면 변수 2의 값을 비교
  3. 변수2의 값이 false 가 아니면 변수2의 값을 왼쪽 변수에 대입
  4. 변수4까지 (변수1 ~ 변수4) 모든 변수가 false 인 값을 가지고 있으면 왼쪽 변수에는 없음 이라는 문자열이 대입된다
  ...
  */
  ...
  //   form_addr = document.querySelector("form.main.unput")
  ...
  const inputButtonClickHandler = (e) => {
    // alert("추가 버튼 클릭");
    // JS 코드에서 form 에 포함된 button 을 클릭했을때 Server 로 데이터를 전송하라
