document.addEventListener("DOMContentLoaded", () => {
  ...
  const navClickHandler = (e) => {
    ...
    if (nav_item.tagName === "LI") {
      ...
      console.log(nav_classList.contains("user"));
      console.log(nav_classList[1]);
      ...
      if (nav_class === "home") {
        ...
        /*
        class="user login" 이라면 /user/login 이라는 location 을 만들고
        class="user join" 이라면 /user/join 이라는 location 을 만들어라
        */
