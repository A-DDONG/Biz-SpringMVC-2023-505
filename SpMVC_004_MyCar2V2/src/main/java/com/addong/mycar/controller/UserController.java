package com.addong.mycar.controller;
...
import com.addong.mycar.service.UserService;

import lombok.extern.slf4j.Slf4j;

/*
 * class scope @RequestMapping 과 method scope @RequestMapping 은
 * 분리되어 있으나 실제 호출될때는 두개가 연결 Mapping 으로 사용된다
 */
...
public class UserController {
	...
	// localhost:8080/rootPath/user/login 으로 Request 되었을때 호출되는 method
