...
<script src="${rootPath}/static/js/detail.js?20230717"></script>
</head>
<body>
	<p>${BBS.b_seq}
	<p>${BBS.b_date}
	...
	<c:if test="${empty BBS.b_image}">
		<img src="${rootPath}/static/images/no_image.png" width="200px" />
	</c:if>
		...
		<div class="image_list">
			<c:forEach items="${FILES}" var="FILE">
				<div class="image">
					...
					<span data-seq="${FILE.i_seq}" data-filename="${FILE.i_originalName}">
						&times;
					</span>
				</div>
			</c:forEach>
